    ...
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#nominate" class="text-sm/6 font-semibold text-white">Nominate Project <span aria-hidden="true">&rarr;</span></a>
        </div>
      </nav>
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
          ...
          <div class="text-center">
            <h1 class="text-balance text-5xl font-semibold tracking-tight text-white sm:text-7xl">GOSIM Spotlight:</h1>
            <h1 class="text-balance text-5xl font-semibold tracking-tight text-white sm:text-7xl">Exceptional Rust</h1>
