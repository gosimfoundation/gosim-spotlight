<template>
  <div id="nominate" class="bg-white py-24 sm:py-32">
      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:pr-4">
          <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
            ...
            <figure class="relative isolate">
              ...
              <p class="mt-4 text-white font-semibold text-xl">This year, 12 winning projects will be selected and showcased at RustWeek 2025 event in Utrecht, Netherlands.</p>
              <figcaption class="mt-6 text-sm/6 text-gray-300">
                <strong class="font-semibold text-white">Contact: </strong> spotlight [at] gosim.org
              </figcaption>
            </figure>
          </div>
        </div>
        <div>
          <div class="text-base/7 text-gray-700 lg:max-w-lg">
            ...
            <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Now accepting nominations!</h1>
            <div class="max-w-xl">
              <p class="mt-6">Know a Rust project that deserves recognition? Don't wait - nominate it today and help us shine a spotlight on its potential. In your submission, please include the following:</p>
            </div>
          </div>
          <dl class="mt-10 space-y-4">
            <div v-for="requirement in requirements" :key="requirement" class="flex items-center gap-x-3">
          ...
          <div class="mt-10">
            <p class="text-base/7 text-gray-600">Contact email: <span class="font-mono">spotlight [at] gosim.org</span></p>
          </div>
          <div class="mt-10 flex">
            <a href="#" class="text-base/7 font-semibold text-indigo-600">
              Learn more about GOSIM <span aria-hidden="true">→</span>
            </a>
          </div>
        </div>
      </div>
