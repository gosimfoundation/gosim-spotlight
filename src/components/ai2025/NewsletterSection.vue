<template>
  <div id="newsletter" class="bg-white py-16 sm:py-24">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="relative isolate overflow-hidden bg-sky-700 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
        ...
        <svg viewBox="0 0 1024 1024" class="absolute left-1/2 top-1/2 -z-10 size-[64rem] -translate-x-1/2" aria-hidden="true">
          ...
          <defs>
            <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(512 512) rotate(90) scale(512)">
              ...
              <stop offset="1" stop-color="#3634ff" stop-opacity="0" />
            </radialGradient>
          </defs>
        </svg>
      </div>
...
async function handleSubmit() {
  ...
  try {
    const response = await fetch(API_URL, {
      ...
      body: JSON.stringify({ email: email.value, page: 'spotlight-ai-newsletter' }),
    })
