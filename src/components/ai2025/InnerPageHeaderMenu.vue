  ...
  <header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="/ai2025" class="-m-1.5 p-1.5">
    ...
    <Dialog as="div" class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
      ...
      <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
        <div class="flex items-center justify-between">
          <a href="/ai2025" class="-m-1.5 p-1.5" @click="mobileMenuOpen = false">
            <span class="sr-only">GOSIM</span>
            <img class="h-8 w-auto" src="@/assets/spotlight-logo.svg" alt="" />
          </a>
...
const navigation = [
  { name: 'The Program', href: '/ai2025/#program' },
  { name: 'Why Participate', href: '/ai2025/#why' },
  { name: 'How It Works', href: '/ai2025/#how-it-works' },
  { name: 'Rules & Eligibility', href: '/ai2025/#rules' },
]
