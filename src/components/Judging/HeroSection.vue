      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
          <div class="text-center">
            ...
            <p class="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">Our panel of experts reviews the
              nominations, focusing on innovation, utility, and community impact. Selected projects are featured on our
              website, newsletter, and social media channels, ensuring they reach a global audience.</p>
          </div>
        </div>
      </div>
      <div
