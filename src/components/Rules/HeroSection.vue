      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
          <div class="text-center">
            ...
            <p class="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">An overview of the rules and
              eligibility criteria for projects to qualify for the GOSIM Rust Spotlight program, ensuring that all
              selected projects meet the program's standards and values.</p>
          </div>
        </div>
      </div>
      <div
